...
import { Users, DollarSign, Package, LogOut, BarChart3 } from "lucide-react";
import logoImage from "@/assets/RocknRoll.jpg";
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">Billiard Hall Manager</h1>
      ...
      <main className="container mx-auto px-6 py-8 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            {/* Standard Room 2 - 1/5 width */}
            <div className="md:col-span-1">
              <KTVRoom
                roomNumber={2}
                status={getKTVStatus(2)}
                onClick={() => handleKTVClick(2)}
              />
            </div>
